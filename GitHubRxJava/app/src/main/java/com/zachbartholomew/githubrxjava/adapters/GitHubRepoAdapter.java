package com.zachbartholomew.githubrxjava.adapters;
...
import com.zachbartholomew.githubrxjava.R;
...
/**
 * A ListAdapter that is in charge of binding GitHubRepo objects into ListView items.
 * The process essentially involves inflating item_github_repo.xml into a View
 * if no recycled View is provided;
 * otherwise, a recycled View is reused to prevent overinflating too many View objects
 */
